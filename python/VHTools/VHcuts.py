...
cuts['W'] = {'MU': "(Muon_isTrigger[W_l1_idx] && Muon_nloose == 1 && Muon_nveto == 1 && Electron_nveto==0)",
             'ELE': "(Electron_isTrigger[W_l1_idx] && Electron_nveto==1 && Muon_nveto == 0)"}
             
cuts['Z'] = {'MU': "((Muon_isTrigger[Z_idx[0]] || Muon_isTrigger[Z_idx[1]]) && Muon_nveto == 2 && Electron_nveto==0)",
             'ELE': "((Electron_isTrigger[Z_idx[0]] || Electron_isTrigger[Z_idx[1]]) && Electron_nveto == 2 && Muon_nveto == 0)"}
