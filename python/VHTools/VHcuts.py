...
for v in ['W', 'Z']:
    ...
    for l in ['ELE', 'MU']:
        ...
        for m in [15, 20, 30, 40, 50, 55]:
            cuts['sr'][v][l][m] = "(" + cuts[v][l] + ")&&(" + cuts['pt'][m] + ")&&(" + cuts['photons'][m] + ")&&(" + cuts['misID'][v][l][m] + ")&&(" + cuts['fsr'][v][m] + ")&&(" + "best_2g_sumID_m{m}==2 && best_2g_valid_m{m})".format(m=m)
            cuts['cr'][v][l][m] = "(" + cuts[v][l] + ")&&(" + cuts['pt'][m] + ")&&(" + cuts['photons'][m] + ")&&(" + cuts['misID'][v][l][m] + ")&&(" + cuts['fsr'][v][m] + ")&&(" + "best_2g_sumID_m{m}==1 && best_2g_valid_m{m})".format(m=m)
