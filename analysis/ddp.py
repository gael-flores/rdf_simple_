...
def zmumuH(data,phi_mass=[7, 15, 20, 30, 40, 50, 55]):
    actions=[]
    ...
    actions.append(zmm2g.Snapshot("Events",'zmm2g.root',cols))
    actions.append(zmm3g.Snapshot('Events','zmm3g.root',cols))
    actions.append(zmm4g.Snapshot('Events','zmm4g.root',cols))
    for tree in ['Runs']:
...
def analysis(data):
    ...
    actions = []
    actions.append(zmumuH(data,[7, 15, 20, 30, 40, 50, 55]))
