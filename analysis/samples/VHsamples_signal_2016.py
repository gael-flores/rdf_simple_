...
for m in [15, 20, 30, 40, 50, 55]:
    for ct in [1000]:
        for br in ['2G2Q']:
            samples_signal_2016['ttH{}_M{}_ctau{}_2016{}'.format(br,m,ct,'preVFP')] = {
                'dataset': 'local:root://cmsxrootd.fnal.gov//store/user/tlam/DDP/UL2016{}/ttH_ttSemiLep_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}mm.root'.format('preVFP', br, m, ct),
                'triggers': ['(HLT_IsoMu24||HLT_IsoTkMu24||HLT_Ele27_WPTight_Gsf)'],
                'veto_triggers': [],
                'era': '2016preVFP',
                'sigma': 0.54,
                'customNanoAOD': True}
            samples_signal_2016['ttH{}_M{}_ctau{}_2016{}'.format(br,m,ct,'postVFP')] = {
                'dataset': 'local:root://cmsxrootd.fnal.gov//store/user/tlam/DDP/UL2016{}/ttH_ttSemiLep_HTo2LongLivedTo{}_MH-125_MFF-{}_ctau-{}mm.root'.format('postVFP', br, m, ct),
                'triggers': ['(HLT_IsoMu24||HLT_IsoTkMu24||HLT_Ele27_WPTight_Gsf)'],
                'veto_triggers': [],
                'era': '2016postVFP',
                'sigma': 0.46,
